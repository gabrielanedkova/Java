...
public class CinemaCity implements CinemaReservationSystem {
    ...
    public CinemaCity(final Map<Movie, List<Projection>> cinemaProgram) {
        this.cinemaProgram = cinemaProgram;
        reservedTickets = new HashSet<Ticket>();
    }

    @Override
    public void bookTicket(final Ticket ticket)
        throws AlreadyReservedException, ProjectionNotFoundException,
